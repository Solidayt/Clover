  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" style="color:#000000;">
          <a class="dropdown-item" href="admin-cart-enteries.php ">Cart Entries</a>
          <a class="dropdown-item" href="admin-inventory.php">Inventory</a>
          <a class="dropdown-item" href="admin-orders.php">Orders</a>
          <a class="dropdown-item" href="admin-contact.php">Contact Info</a>
          <a class="dropdown-item" href="admin-order-enteries.php">Order Enteries</a>
          <a class="dropdown-item" href="admin-add-item.php">Add Product</a>
          <!-- admin pages -->
    ...
    <ul class="nav navbar-nav ml-auto">
      <!--make login.php-->
      <li class="nav-item ">
        <a class="nav-link" href="cart-view.php" style="color:#000000;"> <span class=" fa fa-cart-plus"
            style="font-size:24px;"></a>
        <a class="nav-link" href="logout.php" style="color:#000000;"><span class="fas fa-sign-in-alt"></span> Logout</a>
      </li>
    </ul>
