...
<head>
    <title>Clover Cottage Creations: Car Coasters</title>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-md bg-light navbar-light" style="background-image: url(/photos/dust_scratches.png)">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="nav navbar-nav ml-auto">
                <!--make login.php-->
                <li class="nav-item">
                    <a class="nav-link" href="login.php" style="color:#000000;"><span class="fas fa-sign-in-alt"></span>
                        Login</a>
                </li>
            </ul>
    ...
    <div class="container col-xl-10 col-lg-10 col-md-10 col-sm-10 ">
        ...
        <div class="jumbotron " style="background-color:#abcbea; color:#04080F; ">
            <div class="container-fluid">
                <h1 style="text-align: center;">Cosaters</h1>
                <p>These coasters are 100% Absorbent, handmade; the designs are our original artwork, and Individually
                    Hand-Colored. These coasters come as a set 2 of the same image.
                    <br><br>
                    These coasters are perfect around your own home and for Holiday gifts.
                    <br><br>
                    We have been making these unique absorbing coasters with our special blend of clay for over 25
                    years, selling them at Arts and Crafts shows on the east coast with a very high proportion of
                    repeat customers. They are a uniquely functional and decorative for any home.</p>
            ...
            <div class="row">
                <div class="col-md-4 p-3">
                    <div class="card box-shadow">
                        <img class="card-img-top" src="/photos/indeximg.jpg">
                        <div class="card-body">
                            <p>$24.00</p>
                            <div class="d-flex justify-content-between align-items-center">

                                <a href="addtocart.php" class="btn btn-primary btn-block" role="button">Add to cart</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 p-3">
                    <div class="card box-shadow">
                        <img class="card-img-top" src="/photos/crab.jpg">
                        <div class="card-body">
                            <p>$24.00</p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4 p-3">
                    <div class="card box-shadow">
                        <img class="card-img-top" src="/photos/coaster3.jpg">
                        <div class="card-body">
                            <p>$24.00</p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4 p-3">
                    <div class="card box-shadow">
                        <img class="card-img-top" src="/photos/coaster1.jpg">
                        <div class="card-body">
                            <p>$24.00</p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4 p-3">
                    <div class="card box-shadow">
                        <img class="card-img-top" src="/photos/flips.jpg">
                        <div class="card-body">
                            <p>$24.00</p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4 p-3">
                    <div class="card box-shadow">
                        <img class="card-img-top" src="/photos/butterfly.jpg">
                        <div class="card-body">
                            <p>$24.00</p>
                            <div class="d-flex justify-content-between align-items-center">
