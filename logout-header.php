<nav class="navbar navbar-expand-md bg-light navbar-light body-font" style="background-image: url(/photos/dust_scratches.png)">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      ...
      <ul class="nav navbar-nav ml-auto">
        <!--make login.php-->
        <li class="nav-item ">
          <a class="nav-link" href="cart-view.php" style="color:#000000;"> <span class=" fa fa-cart-plus" style="font-size:24px;"></a>
